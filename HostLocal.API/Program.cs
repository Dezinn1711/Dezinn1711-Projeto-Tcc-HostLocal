using System.Text;
using HostLocal.API.Data;
using HostLocal.API.Middleware;
using HostLocal.API.Models;
using HostLocal.API.Services.Implementations;
using HostLocal.API.Services.Interfaces;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "HostLocal v1");
